    ...
    <div class="container">
     ...
     <nav>
      ...
      <li class="MacBook"><a href="MacBook.html"target="blank">MacBook</a> 
    	...
    	<div class="box1">
            <a href="./img/iphone8plus.jpg">
    		<img src="./Img/img/iphone8plus.jpg">
    		</a>
    		<h3>Iphone 8plus</h3>
    		<div  class="Price">
    		<p class="Price">Price:299$ </p>
           <div ><img src="./Img/img/cart.png"></div>
    		</div>
    	</div>
    	<div class="box2">
            <a href="./img/iphonex.jpg">
    		<img src="./img/iphonex.jpg" >
    		</a>
    		<h3>Iphone X</h3>
    		<div  class="Price">
    		<p class="Price">Price:799$ </p>
            <div class="cart-img"><img src="./img/cart.png"></div>
    		</div>
    	</div>
    	<div class="box3">
            <a href="./Img/img/iphonexs.jpg">
    		<img src="./Img/img/iphonexs.jpg" >
    		</a>
    		<h3>Iphone XS </h3>
    		<div  class="Price"></div>
    		<p class="Price">Price:899$ </p>
            <div class="cart-img"><img src="./Img/img/cart.png"></div>
    		
    	</div>
    	<div class="box4">
            <a href="./Img/img/iphonexsmax.jpg">
    		<img src="./Img/img/iphonexsmax.jpg" >
    		</a>
    		<h3>Iphone XS Max</h3>
    		<div class="Price"></div>
    		<p>Price:999$ </p>
